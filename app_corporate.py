...
# Build: PU ExpertCenter Enterprise - Corporate Version
import openai
import os
...
class PUExpertCenterMinimal:
    ...
    def generate_answer(self, question, search_results):
        ...
        prompt = f"""Based on the following context about polyurethane technology, answer the question: {question}
...
def check_password():
    ...
    if not st.session_state.authenticated:
        ...
        st.markdown("Please enter your corporate credentials to access PU ExpertCenter.")
...
def main():
    ...
    st.set_page_config(
        page_title="PU ExpertCenter - Corporate Version",
        layout="wide",
    ...
    # Logo and title side by side with perfectly aligned tops
    ...
    with col2:
        st.markdown("<h1 style='margin-top: 0; margin-bottom: 5px;'>Polyurethane ExpertCenter</h1>", unsafe_allow_html=True)
        
        # Tagline directly below title with minimal spacing
        ...
        st.markdown(f"<p style='color: #666; margin-top: 0; margin-bottom: 0; font-size: 14px;'>{tagline}</p>", unsafe_allow_html=True)

    # Horizontal line with minimal spacing
    st.markdown("---")
...
<head>
  ...
  <title>PU ExpertCenter - Corporate Response</title>
  <style>
    @page {{
      margin: 2cm;
      size: A4;
  ...
  <div class="container">
    <div class="header">
      <div class="logo-section">
        <div class="logo-text">PU ExpertCenter</div>
      </div>
